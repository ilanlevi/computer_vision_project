from consts import FACIAL_LANDMARKS_68_IDXS_FLIP as FLIPPED_INDEXES, DataSetConsts
from .fpn_wrapper_model import MyFpnWrapper
from .my_landmarks_generator import LandmarkWrapper


class ImageDataGeneratorPose(object):
    def __init__(self,
                 datagen,
                 gen_y=True,
                 fpn_wrapper=MyFpnWrapper(),
                 ...
                 flip_indices=FLIPPED_INDEXES,
                 target_shape=None):
        """
        :param datagen : Keras's ImageDataGenerator
        :param gen_y : create pose from images or not, default is True
        :param preprocessing_function : The function that will be implied on each input.
                                 The function will run after the image is resized and augmented.
                                 The function should take one argument: one image (Numpy tensor with rank 3),
                                 and should output a Numpy
        :param target_shape            : If target_shape is not None,
